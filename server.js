...
import MedicineScheduleRoutes from './src/routes/MedicineScheduleRoutes.js';
...
app.use('/api/portal/reports', ReportRoutes);
app.use('/api/portal/medicine-schedule', MedicineScheduleRoutes);
app.use('/api/medilink', MedilinkRoutes);
app.use('/api/portal/profile', ProfileRoutes);
app.use('/api/portal/diagnosis', DiagnosisRoutes);
